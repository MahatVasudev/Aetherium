...
const file_proto_search_proto_rawDesc = "" +
	...
	"\aresults\x18\x01 \x03(\tR\aresults2H\n" +
	"\rSearchService\x127\n" +
	"\x06Search\x12\x15.search.SearchRequest\x1a\x16.search.SearchResponseB?Z=github.com/MahatVasudev/Aetherium/backend/proto/search;searchb\x06proto3"
